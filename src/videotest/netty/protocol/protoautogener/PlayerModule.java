...
public final class PlayerModule {
  ...
  public static final class PBPlayer extends
    ...
    public static PlayerModule.PBPlayer parseFrom(
    ...
    public static PlayerModule.PBPlayer parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static PlayerModule.PBPlayer parseFrom(
    ...
    public static PlayerModule.PBPlayer parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static PlayerModule.PBPlayer parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static PlayerModule.PBPlayer parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder(PlayerModule.PBPlayer prototype) {
    ...
    public static final class Builder extends
       ...
       implements PlayerModule.PBPlayerOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return PlayerModule.internal_static_PBPlayer_descriptor;
      }
      ...
      // Construct using PlayerModule.PBPlayer.newBuilder()
      private Builder() {
      ...
      public com.google.protobuf.Descriptors.Descriptor
        ...
        return PlayerModule.PBPlayer.getDescriptor();
      }
      
      public PlayerModule.PBPlayer getDefaultInstanceForType() {
        return PlayerModule.PBPlayer.getDefaultInstance();
      }
      
      public PlayerModule.PBPlayer build() {
        PlayerModule.PBPlayer result = buildPartial();
      ...
      private PlayerModule.PBPlayer buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        PlayerModule.PBPlayer result = buildPartial();
        if (!result.isInitialized()) {
      ...
      public PlayerModule.PBPlayer buildPartial() {
        PlayerModule.PBPlayer result = new PlayerModule.PBPlayer(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof PlayerModule.PBPlayer) {
          return mergeFrom((PlayerModule.PBPlayer)other);
        } else {
      ...
      public Builder mergeFrom(PlayerModule.PBPlayer other) {
        if (other == PlayerModule.PBPlayer.getDefaultInstance()) return this;
  ...
  public static final class PBResource extends
    ...
    public static PlayerModule.PBResource parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    ...
    public static PlayerModule.PBResource parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return newBuilder().mergeFrom(data).buildParsed();
    }
    public static PlayerModule.PBResource parseFrom(
    ...
    public static PlayerModule.PBResource parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return newBuilder().mergeFrom(input).buildParsed();
    }
    public static PlayerModule.PBResource parseFrom(
    ...
    public static PlayerModule.PBResource parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      Builder builder = newBuilder();
      if (builder.mergeDelimitedFrom(input)) {
        return builder.buildParsed();
    ...
    public static PlayerModule.PBResource parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      Builder builder = newBuilder();
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(PlayerModule.PBResource prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements PlayerModule.PBResourceOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return PlayerModule.internal_static_PBResource_descriptor;
      }
      ...
      // Construct using PlayerModule.PBResource.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public com.google.protobuf.Descriptors.Descriptor
          getDescriptorForType() {
        return PlayerModule.PBResource.getDescriptor();
      }
      
      public PlayerModule.PBResource getDefaultInstanceForType() {
        return PlayerModule.PBResource.getDefaultInstance();
      }
      
      public PlayerModule.PBResource build() {
        PlayerModule.PBResource result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      private PlayerModule.PBResource buildParsed()
          throws com.google.protobuf.InvalidProtocolBufferException {
        PlayerModule.PBResource result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(
      ...
      public PlayerModule.PBResource buildPartial() {
        PlayerModule.PBResource result = new PlayerModule.PBResource(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof PlayerModule.PBResource) {
          return mergeFrom((PlayerModule.PBResource)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(PlayerModule.PBResource other) {
        if (other == PlayerModule.PBResource.getDefaultInstance()) return this;
        if (other.hasGold()) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "nergy\030\002 \002(\005B\036\n\016protoautogenerB\014PlayerMod" +
      "ule"
    };
        ...
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_PBPlayer_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              PlayerModule.PBPlayer.class,
              PlayerModule.PBPlayer.Builder.class);
          internal_static_PBResource_descriptor =
          ...
          internal_static_PBResource_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              ...
              PlayerModule.PBResource.class,
              PlayerModule.PBResource.Builder.class);
          return null;
        }
      };
